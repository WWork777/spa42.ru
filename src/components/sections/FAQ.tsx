...
const items: Item[] = [
  ...
  },
  {
    ...
    a: "Запись на программу происходит за 15-30 минут. Если Вы желаете провести в нашем салоне мероприятие (День рождения), необходимо связаться с нашим администратором по номеру телефона: +7 (983) 210-34-33, чтобы согласовать дату, время и мастеров.",
  },
];
